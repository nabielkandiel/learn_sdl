...
ResetButton::ResetButton(GameContext &context)
    : ObjectBase(context),
...
void ResetButton::handleMouseMotion()
{
    if (!isInside()) {
        return;
    }
...
void ResetButton::handleMouseButtonDown()
{
    if (!isInside()) {
        return;
    }
...
void ResetButton::handleMouseButtonUp()
{
    if (!isInside()) {
        return;
    }
